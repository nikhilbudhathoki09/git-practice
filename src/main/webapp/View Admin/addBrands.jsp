        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Add Brands</span>
                </div>
                <div class="boxes">
                    <div class="product-form">
                         <form action="${pageContext.request.contextPath}/AdminAddBrands" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            <label for="name">Brand Name:</label>
                            <input type="text" id="name" name="brand-name" placeholder="Enter brand name...">
                          </div>
                          <div class="form-group">
