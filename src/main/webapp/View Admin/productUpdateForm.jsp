                    ...
                    <div class="product-form">
                        ...
                        <% for(Products product: productDescription){%>
                          ...
                          <div class="form-group">
				            ...
				            String query2 = "Select brand_name from brands Where brand_id <>"+product.getBrand_id();
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" id="name" name="product-name" value="<%=product.getProduct_name()%>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" id="price" name="product-price" value="<%=product.getProduct_price()%>">
                          </div>
                          <div class="form-group">
                            <label for="description">Product Description:</label>
                            <textarea id="description"  name="product-description"><%=product.getProduct_desc()%></textarea>
                          </div>
